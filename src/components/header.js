      ...
      <nav className={styles.desktopNav}>
        {navLinks?.map((item, index) => (
          <React.Fragment key={index}>
            {item.sub_links ? (
              <MenuDropdown title={item.title} items={item.sub_links} />
            ) : (
              <Link
                to={item.link}
